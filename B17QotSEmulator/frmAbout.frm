...
Private Sub Form_Load()
    ...
    lblTitle.Caption = """B-17: Queen of the Skies"" Emulator"

    strDesc = _
    "Release 1.x development: Preston McMurry" & vbCrLf & vbCrLf & _
    "Original Prototype: Mike Pranno" & vbCrLf & _
    "Additional Development: Shaun Foster" & vbCrLf & _
    "Tab Pseduo-Control: Stefaan Casier"

    txtDescription.Text = strDesc
                          
    lblDisclaimer.Caption = """B-17: Queen of the Skies"", " & Chr(169) & "1982, The Avalon Hill Game Company"
